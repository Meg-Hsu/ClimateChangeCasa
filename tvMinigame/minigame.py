...
image1 = pygame.image.load(os.getcwd()+"/tvMinigame/warm_1.png")
image2 = pygame.image.load(os.getcwd()+"/tvMinigame/warm_2.png")
image3 = pygame.image.load(os.getcwd()+"/tvMinigame/warm_3.png")
image4 = pygame.image.load(os.getcwd()+"/tvMinigame/warm_4.png")
image5 = pygame.image.load(os.getcwd()+"/tvMinigame/warm_5.png")
